...
";
    ...
    assert_eq!(dset, DataSet::new("Test data", vec![
            Column::new("int", ColumnData::U8 {
                    values: vec![Some(1), Some(4)]
                }),
            Column::new("float", ColumnData::F64 {
                    values: vec![Some(2.0), None]
                }
            ),
            Column::new("text", ColumnData::String {
                    values: vec![
                        Some("three".to_owned()),
                        Some("7".to_owned())
                    ]
            ...
            Column::new("color", ColumnData::Nominal {
